<div class="row">
    <div class="col-12">
        <div class="card-box table-responsive">
            <h4 class="m-t-0 header-title">List Approve Cabut Blokir Nasabah</h4>
            <p class="text-muted font-14 m-b-30">
                Daftar list nasabah telah dicabut blokir cabang dan perlu validasi blokir.
            </p>

            <table id="unblockApproveDataTable" class="table table-bordered table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                <thead>
                    <tr>
                ...
                <tbody>
                    ...
                    <?php foreach ($data_blokir as $result) : ?>
                        <tr>
                            ...
                            <td>
                                <a href="<?= base_url("/unblock-approve-input/" . $result->id) ?>">
...
<script>
    $('#unblockApproveDataTable').DataTable({
        searching: false,
        paging: false,
        info: false
    });
