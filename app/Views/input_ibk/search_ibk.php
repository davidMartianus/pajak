<div class="container-fluid">
        ...
        <div class="col-xl-12">
            <div class="page-title-box">
                ...
                <ol class="breadcrumb float-right">
                    ...
                    <li class="breadcrumb-item active">Pencarian IBK</li>
                </ol>
    ...
    <div class="card">
        <div class="card-body">
            ...
            <table id="listIbkTable" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                <thead>
                    <tr>
                        <th>No.</th>
                        <!-- <th>Reff Code</th> -->
